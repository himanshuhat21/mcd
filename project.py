    ...
    if choice_user == "CLEANING":
        ...
        while True:
            ...
            if pol_case == "FIR":
                ...
                print("AFTER 3 MINUTES YOU WLL GET A OTP(DO NOT SHARE IT WITH ANYONE)")
        ...
        while True:
            ...
            if pds_choice == 'ORANGE CARD':
                ...
                print("WRONG CHOICE! HENCE NOTHING IS UPDATED YET FOR YOU. OR YOU CAN CALL Ph. 2323143454")
                break
        break
            ...
            if ed_choice == 'NUR':
                ...
                while True:
                    ...
                    if nur_choice == '1':
                        ...
                        print("SO YOUR COMPLAINT IS AGAINST Mr/Mrs", teach_nam6,"AND THE MAIN COMPLAINT IS", your_comp6)
                        break
                    elif nur_choice == '3':
                        print("WHICH SUBJECT TEACHER IS NOT ATTENTIVE? FILL THE GIVEN FORM SO THAT WE CAN START OUR INVESTIGATION")
                ...
                if sen_choice == '11':
                    ...
                    if stream_choice == 'SCIENCE' or stream_choice == 'SCI':
                        ...
                        sci_choice = input("ENTER THE STREAM SUBJECTS: ")
                        if sci_choice == 'PCM':
                            ...
                            while True:
                                ...
                                print("2.)TEACHERS ARE NOT COMING FOR GIVING CLASSES.")
                                print("3.)NO CO-CURRICULAR ACTIVITES HAVE BEEN ORGANISED.")
                                ele_choice1 = input("ENTER THE SUITABLE MCHOICE CODE FOR COMPLAIN: ")
                                if ele_choice1 == 'A':
                                    print("WE WOULD LOVE TO KNOW WHICH PROBLEM")
                                    ncert_prob20 = input("ENTER EHICH PROBLEM: ")
                                    if ncert_prob20 == 'NOT AVAILABLE':
                                    ...
                                    print("WE WILL SUGGEST YOU TO MEET THE SCHOOL TEACHER OR ANY CONSULATNAT.")
                                    break
                            break
                        else:
                            print("nothing is left in science stream.")
                            break
                        break    
                    ...
                    if stream_choice1 == 'SCIENCE' or stream_choice1 == 'SCI':
                        print("SCIENCE STREAM HAS TWO CHOICE OF SUBJECTS (PCM/PCB): ")
                        sci_choice1 = input("ENTER THE STREAM SUBJECTS: ")
                        if sci_choice1 == 'PCM':
                            print("SO YOUR WARD IS FROM A NON MEDICAL FIELD.")
                            print("DO YOU HAVE SOME COMPLAINTS ABOUT SCHOOL?")
                            while True:
                                ...
                                if twe_choice == 'A':
                                    ...
                                    print("PLEASE ENTER THE NAME TEACHERS WHO ARE NOT GIVING CLASSES.")
                                    teach_class2320 = input("ENTER THE TEACHER NAME WHO IS NOT GIVNG CLASS: ")
                                    scul_class2320 = input("ENTER SCHOOL NAME: ")
                                    print("SO WE WILL CONTACT YOUR SCHOOL",scul_class2320,"AND WILL TALK TO Mr/Mrs.",teach_class2320)
                                    break
                                elif twe_choice == 'C':
                                    print("PLEASE ENTER THE NAME TEACHERS WHO ARE NOT ORGANIZING CO-CURRCULAR ACTIVITES.")
                                    teach_class2420 = input("ENTER THE TEACHER NAME WHO NOT ORGANIZING CO-CURRCULAR ACTIVITES: ")
                                    scul_class2420 = input("ENTER SCHOOL NAME: ")
                                    print("SO WE WILL CONTACT YOUR SCHOOL",scul_class2420,"AND WILL TALK TO Mr/Mrs.",teach_class2420)      
                                    break
                                else:
                                    print("WE WILL SUGGEST YOU TO MEET THE SCHOOL TEACHER OR ANY CONSULATNAT TO SEE MORE PROBLEMS.")
                                    break
                            break        
                        elif sci_choice1 == 'PCB':
                            print("SO YOUR WARD IS FROM A NON MEDICAL FIELD.")
                            print("DO YOU HAVE SOME COMPLAINTS ABOUT SCHOOL?")
                            while True:
                                print("1.)NCERT BOOKS NOT AVAILABLE/SELLING ON HIGH PRICE.")
                                print("2.)TEACHERS ARE NOT COMING FOR GIVING CLASSES.")
                                print("3.)NO CO-CURRICULAR ACTIVITES HAVE BEEN ORGANISED.")
                                twe_choice1 = input("ENTER THE SUITABLE MCHOICE CODE FOR COMPLAIN: ")
                                if twe_choice1 == 'A':
                                    print("WE WOULD LOVE TO KNOW WHICH PROBLEM")
                                    ncert_prob2022 = input("ENTER EHICH PROBLEM: ")
                                    if ncert_prob2022 == 'NOT AVAILABLE':
                                        print("PLEASE ENTER THE NAME OF BOOK STORE.\nSO THAT WE CAN CONTACT THAT BOOK STORE AND HELP THEM TO DELIVER THEIR BOOK AS SOON AS POSSIBLE.")
                                        book_store2122 = input("ENTER THE BOOK STORE NAME: ")
                                        loc_book_store2122 = input("PLEASE ENTER THE ADDRESS OF BOOK STORE: ")
                                        print("WE HAVE RECORDED THE NAME OF BOOK STORE",book_store2122,"AND WE SHALL HELP THEM TO GET THEIR DELEIVERY AS SOON AS POSSIBLE WITH ADDRESS:-\n",loc_book_store2122)
                                        break
                                    elif ncert_prob2022 == 'HIGH PRICE':
                                        print("PLEASE ENTER THE NAME OF BOOK STORE.\nSO THAT WE CAN CONTACT THAT BOOK STORE AND CAN REGISTER POLICE CASE ON THEM.")
                                        book_store2222 = input("ENTER THE BOOK STORE NAME: ")
                                        loc_book_store2222 = input("PLEASE ENTER THE ADDRESS OF BOOK STORE: ")
                                        print("WE HAVE RECORDED THE NAME OF BOOK STORE",book_store2222,"AND WE SHALL REACH THEIR AS SOON AS POSSIBLE WITH ADDRESS:-\nFOR INVEESTIGATION\n",loc_book_store2222)
                                        break
                                    else:
                                        print("SORRY INPUT IS WRONG!")
                                        break
                                    ...
                                    print("PLEASE ENTER THE NAME TEACHERS WHO ARE NOT GIVING CLASSES.")
                                    teach_class2323 = input("ENTER THE TEACHER NAME WHO IS NOT GIVNG CLASS: ")
                                    scul_class2323 = input("ENTER SCHOOL NAME: ")
                                    print("SO WE WILL CONTACT YOUR SCHOOL",scul_class2323,"AND WILL TALK TO Mr/Mrs.",teach_class2323)
                                    break
                                elif twe_choice1 == 'C':
                                    print("PLEASE ENTER THE NAME TEACHERS WHO ARE NOT ORGANIZING CO-CURRCULAR ACTIVITES.")
                                    teach_class2423 = input("ENTER THE TEACHER NAME WHO NOT ORGANIZING CO-CURRCULAR ACTIVITES: ")
                                    scul_class243 = input("ENTER SCHOOL NAME: ")
                                    print("SO WE WILL CONTACT YOUR SCHOOL",scul_class2423,"AND WILL TALK TO Mr/Mrs.",teach_class2423)      
                                    break
                                else:
                                    print("WE WILL SUGGEST YOU TO MEET THE SCHOOL TEACHER OR ANY CONSULATNAT.")
                                    break
        ...
        if water_choice == 'A':
            ...
            if water_man_name1 == 22:
                ...
                print("THE PERSON",water_man_name,"IS CHARGING YOU HIGHER THAN THE ORIGINAL RATE THAT IS ₹22 PER 1000l AND HE /SHE CHARGES",water_man_name1,"WHICH IS HIGHER\nWE WILL INVESTIGATE THAT OFFICER OR FRAUD.\nTAHNKS!")
                break
            else:
                print("nothing is left!")
                break    
        ...
        print("THIS COMPLAINT WAS FILED BY Mr/Mrs",name,"JI")
        break          
print("\nTHIS WAS A PROJECT BY:\n1.)HIMANSHU BISWAS(07)\n2.)ANANAD KUMAR BOSE(12).\nEND OF THE PROJECT\nTHANK YOU VERY MUCH")